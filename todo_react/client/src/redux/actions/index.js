...
import { TOGGLE_TAB, ADDNEW_TODO, GETALL_TODO, TOGGLE_TODO, UPDATE_TODO, DELETE_TODO } from './type';
...
export const getAllTodos = () => async (dispatch) => {
    try{
        ...
        console.log('Error while geting all todos',error.message)
    }
}
...
export const toggleTodo = (id) => async (dispatch) => {
    try{
        ...
        console.log('Error while toggling a todo',error.message)
    }
}
